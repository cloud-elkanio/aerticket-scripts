# Generated by Django 5.0.6 on 2024-07-26 05:20
...
def create_lookup_country(apps, schema_editor):
    country_model = apps.get_model('users' , 'LookupCountry')
    for country in country_details:
        lookup_obj, created = country_model.objects.update_or_create(country_name = country['Country'], country_code= country['CountryCode'])
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(create_lookup_country)
    ]
