...
from vendors.buses.utils import create_uuid
...
class Mongo:
    def __init__(self):
        ...
        self.searches = self.db['bus_searches']
        self.staticData = self.db['bus_staticData']
        self.bus_supplier = self.db['bus_suppliers']
        self.session_data = []
    ...
    def log_vendor_api(self,data):
        try:
            ...
            self.bus_supplier.insert_one(master_doc)
        except:
            pass
